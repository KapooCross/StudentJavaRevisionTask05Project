...
public class Task02 {
    public static String task02(int a, int b, int c, int d) {
        String massage = "No arithmetic progression.";
        int step = Math.abs(a - b);


        if (a > b && b > c && c > d && (b - c == step) && (c - d == step)) {
                massage = "Descending arithmetic progression.";
        }
        if (a < b && b < c && c < d && (c - b == step) && (d - c == step)) {
                massage = "Ascending arithmetic progression.";
        }
        if (a == b && b == c && c == d) {
            massage = "Monotonic arithmetic progression.";
        }
